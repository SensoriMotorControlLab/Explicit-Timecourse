...
learning per rotation group [Reach script](reachstats.r)
...
1) Is final mean aim deviation different from final aligned mean in each
group?
...
1) Step model - Do participant deviate their aim in 1 step and does this
aim stay stable?
...
61 participants do not fit with the exponential model (n=44 for
...
![](R/Figures/UnsuperCluster.png){width="417"}
