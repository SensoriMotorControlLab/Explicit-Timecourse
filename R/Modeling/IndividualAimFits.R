...
df <- strategy_data[strategy_data$participant_id == "19187c", ] 
...
df <- strategy_data[strategy_data$participant_id == "a5310d", ] 
...
#- gradual -#
df <- strategy_data[strategy_data$participant_id == "81d984", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#3dcad4", lwd = 2)
abline(v = 89, col = "grey", lty = 2, lwd = 1)
abline(h = 40, col = "grey", lty = 2, lwd = 1)


df <- strategy_data[strategy_data$participant_id == "58e451", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#3dcad4", lwd = 2)
...
df <- strategy_data[strategy_data$participant_id == "4a6642", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#3dcad4", lwd = 2)
abline(v = 89, col = "grey", lty = 2, lwd = 1)
...
df <- strategy_data[strategy_data$participant_id == "bde44b", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#3dcad4", lwd = 2)
abline(v = 89, col = "grey", lty = 2, lwd = 1)
...
#-- step --#
df <- strategy_data[strategy_data$participant_id == "1c10b9", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#d16483", lwd = 2)
abline(v = 113, col = "grey", lty = 2, lwd = 1)
...
df <- strategy_data[strategy_data$participant_id == "20d744", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#d16483", lwd = 2)
abline(v = 113, col = "grey", lty = 2, lwd = 1)
abline(h = 30, col = "grey", lty = 2, lwd = 1)


df <- strategy_data[strategy_data$participant_id == "8bc9fd", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#d16483", lwd = 2)
abline(v = 113, col = "grey", lty = 2, lwd = 1)
...
df <- strategy_data[strategy_data$participant_id == "abf95a", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#d16483", lwd = 2)
abline(v = 113, col = "grey", lty = 2, lwd = 1)
...
df <- strategy_data[strategy_data$participant_id == "654648", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#c495c9", lwd = 2)
abline(v = 113, col = "grey", lty = 2, lwd = 1)
...
df <- strategy_data[strategy_data$participant_id == "ab3b79", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#c495c9", lwd = 2)
abline(v = 113, col = "grey", lty = 2, lwd = 1)
...
df <- strategy_data[strategy_data$participant_id == "bdb042", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#c495c9", lwd = 2)
abline(v = 113, col = "grey", lty = 2, lwd = 1)
...
df <- strategy_data[strategy_data$participant_id == "f275ca", ] 
plot(df$aimdeviation_deg, type = "l", main = "", ylim = c(-58, 80),
     xlim = c(0, 232),
     col= "#c495c9", lwd = 2)
abline(v = 113, col = "grey", lty = 2, lwd = 1)
